...
outcome:
    ...
    - Unfortunately we were unable to get quantitative results due to a lack of analytics tools, but the customer support team was very happy with the results, and so were our users.
tools:
